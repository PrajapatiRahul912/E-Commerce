...
mongoose.connect('mongodb+srv://rahulkumar:184783031458@cluster0.vbuwtfq.mongodb.net/');
...
app.get('/newcollections', async (req,res)=>{
    ...
    // creating a endpoint for popular in women
    ...
    // creating endpoint for retrieve cart data when user login 
